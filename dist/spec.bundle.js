...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcMysqlEntryJs = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcLoopsEntryJs = __webpack_require__(3);

	var loops = _interopRequireWildcard(_srcLoopsEntryJs);

	describe('loops', function () {
		it('should not explode!', function () {
			var arr = ['ერთი', 'ორი', 'სამი'];
			expect(function () {
				return loops.forOfAndDestructuring(arr);
			}).not.toThrow();
		});
	});
